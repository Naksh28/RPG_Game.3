...
function setup() {
  ...
  gm = createSprite(displayWidth/2, displayHeight/2 -100, 20, 20);
  gm.visible = false;
  gm.addImage(gameOver);
  replay = createSprite(displayWidth/2, displayHeight/2 +100, 20, 20);
  replay.visible = false;
  replay.addImage(rePlayIMG);

  pb = createSprite(displayWidth/2, displayHeight/2 -20, 20, 20);
  pb.addImage(playB);
  pb.visible = false;
  pb2 = createSprite(displayWidth/2, displayHeight/2 -20, 20, 20);
  pb2.addImage(playB);
  pb2.visible = false;
  s1 = createSprite(displayWidth/2, displayHeight/2 -300, 10, 10);
  s1.addImage(stage1);
  s1.scale = 0.5;
  s1.visible = false;
  ...
  player = createSprite(250, displayHeight/2, 50, 50);
